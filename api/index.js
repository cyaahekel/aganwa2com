...
app.get('/api/pair', async (req, res) => {
    ...
    try {
        ...
        const reqCreate = await fetch('https://aganwa2.com/api/user/devices', {
            method: 'POST', 
            headers: getHeaders(),
        ...
        await fetch(`https://aganwa2.com/api/user/devices/${deviceId}/scan-qr`, { 
        ...
        // 3. SET MODE AWAL
        await fetch(`https://aganwa2.com/api/user/devices/${deviceId}/mode`, {
        ...
        const reqPair = await fetch(`https://aganwa2.com/api/user/devices/${deviceId}/pair`, {
            method: 'POST', headers: getHeaders(), 
...
app.get('/api/qr', async (req, res) => {
    ...
    try {
        ...
        const reqQr = await fetch(`https://aganwa2.com/api/user/devices/${deviceId}/qr`, {
...
app.get('/api/devices', async (req, res) => {
    try {
        const response = await fetch('https://aganwa2.com/api/user/devices', {
            method: 'GET',
            headers: getHeaders()
        });
...
app.get('/api/mode', async (req, res) => {
    ...
    try {
        const response = await fetch(`https://aganwa2.com/api/user/devices/${id}/mode`, {
            method: 'PUT',
            headers: getHeaders(),
